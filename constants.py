...
QUICK_LOOKUP_CACHE_VERSION = "v22"
SIMPLE_LOOKUP_CACHE_VERSION = "v7"
...
MAX_AUTO_LIMIT = MAX_CARDS_PER_RUN
AI_TOPIC_WORDLIST_MAX = 50
AI_WORD_SELECTION_INPUT_LIMIT = 800
AI_WORD_SELECTION_MAX_OUTPUT = MAX_CARDS_PER_RUN
...
TTS_TASK_TIMEOUT_SECONDS = 20
TTS_REQUEST_SPACING_SECONDS = 0.4
...
CARD_TEMPLATES = {
    ...
    "definition_front": {
        "label": "3. 例句挖空（首字母提示）",
        "description": "正面显示例句挖空和首字母提示；反面显示单词、词性英文释义和例句。",
    },
}
